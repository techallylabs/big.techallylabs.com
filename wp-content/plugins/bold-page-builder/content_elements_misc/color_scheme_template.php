...
if ( ! isset( $color_scheme[2] ) ) {
	...
	$custom_css = "
		...
		.bt_bb_separator_v2.bt_bb_color_scheme_{$scheme_id} {
			color: {$color_scheme[1]};
		}
		
		div.bt_bb_color_scheme_{$scheme_id}.bt_bb_separator_v2 .bt_bb_separator_v2_inner .bt_bb_separator_v2_inner_before, 
		div.bt_bb_color_scheme_{$scheme_id}.bt_bb_separator_v2 .bt_bb_separator_v2_inner .bt_bb_separator_v2_inner_after {
			border-color: {$color_scheme[2]};
		}
