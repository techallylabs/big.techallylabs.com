...
<div class="btCartWidget btIconWidget<?php do_action( 'woocommerce_before_mini_cart_class' ); ?>">
	<span class="btCartWidgetIcon btIconWidgetIcon">
		...
		?>
		<span class="cart-contents" title="<?php echo esc_attr__( 'View your shopping cart', 'nifty' ) ; ?>"><?php echo WC()->cart->get_cart_contents_count(); ?></span>
	</span>
	...
	<div class="btCartWidgetInnerContent btImageTextWidgetWrapper btIconWidgetContent">
		...
		<ul class="cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
			...
			<?php if ( ! WC()->cart->is_empty() ) : 
				...
				<li class="empty"><?php echo esc_html__( 'No products in the cart.', 'nifty' ); ?></li>
	...
	<?php if ( ! WC()->cart->is_empty() ) : ?>
		...
		<p class="total"><strong><?php echo esc_html__( 'Subtotal', 'nifty' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>

		<?php do_action( 'woocommerce_widget_shopping_cart_before_buttons' ); ?>

		<p class="buttons">
			<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button wc-forward"><?php esc_html( _e( 'View Cart', 'nifty' ) ); ?></a>
			<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward"><?php esc_html( _e( 'Checkout', 'nifty' ) ); ?></a>
		</p>
