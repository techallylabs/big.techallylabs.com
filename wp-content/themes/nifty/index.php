		...
		<section class="bt-no-search-results bt_bb_section bt_bb_top_spacing_large bt_bb_bottom_spacing_large gutter">
			...
			<div class="bt_bb_port">
				...
				echo boldthemes_get_heading_html(
					array(
						'headline' => esc_html__( 'We are sorry, no results for: ', 'nifty' ) . get_search_query(),
						'subheadline' => '',
						'size' => 'large'
					)
				);
				...
				<form role="search" method="get" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
					<input type="search" value="<?php echo esc_attr( get_search_query() )  ?>" placeholder="<?php echo esc_attr__( 'Enter search term', 'nifty')  ?>" name="s" id="s" >
					<input type="submit" value="<?php echo esc_attr__( 'Search', 'nifty')  ?>">
				</form>
