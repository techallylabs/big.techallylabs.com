				...
				echo '<div class="btArticleContent">';
					...
					if ( ( BoldThemesFrameworkTemplate::$cf != '' && count( BoldThemesFrameworkTemplate::$cf ) > 0 ) || $share_html != '' ) {
						echo '<div class="btArticleSuperMeta">';
							...
							if ( $share_html != '') echo '<div class="btShareRow"><div class="btInnerShare">' . wp_kses( $share_html, 'share' ) . '<span class="btShareText">' . esc_html__( 'Share', 'nifty' ) . '</span></div></div><!-- /btShareRow -->';
